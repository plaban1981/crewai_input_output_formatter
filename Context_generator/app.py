...
class EducationAssistant:
    def __init__(self):
        # Initialize agents directly with LLM
        ...
        self.project_suggestion_agent = Agent(
    ...
    def generate_personalized_content(self, topics: List[str], expertise_level: ExpertiseLevel):
        # Create tasks with proper formatting and validation
        create_learning_material_task = Task(
            ...
            agent=self.learning_material_agent,
        ...
        create_project_suggestion_task = Task(
            ...
            agent=self.project_suggestion_agent,
        ...
        # Create and run crew
        crew = Crew(
            agents=[self.learning_material_agent, self.quiz_creator_agent, self.project_suggestion_agent],
